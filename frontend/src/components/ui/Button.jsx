...
const Button = ({ 
  ...
  const variants = {
    primary: "bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-500/30 focus:ring-indigo-500",
    secondary: "bg-pink-500 text-white hover:bg-pink-600 shadow-lg shadow-pink-500/30 focus:ring-pink-500",
